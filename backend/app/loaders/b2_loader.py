# 8) backend/app/loaders/b2_loader.py
...
# Lo descarga a una carpeta temporal
def download_file_from_b2(filename: str) -> str:
    """
    Descarga un archivo desde Backblaze a un directorio.
    """
...
# Devuelve una lista de los nombres de todos los archivos del bucket (prueba).
